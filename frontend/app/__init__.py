...
def create_app():
    ...
    from .routes import auth, dashboard, operacoes, analises, admin, proventos, ativos_catalogo, planos, alertas, fiscal, relatorios, ferramentas, carteira, configuracoes
