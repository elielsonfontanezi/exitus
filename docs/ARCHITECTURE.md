...
| Testes IR (IR-001 a IR-004 + IR-007) | `tests/test_ir_integration.py` | 34 testes — apuração, DARF, histórico, PM posicao, compensação prejuízo, regras dinâmicas, proventos |
