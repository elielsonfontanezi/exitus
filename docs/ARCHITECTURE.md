...
**Características**:
- 52+ rotas principais (Sprint 1–7 concluídos)
- 52+ templates Jinja2
- Session management (JWT)
- Blueprints: auth, dashboard, operacoes, analises, admin, proventos, ativos_catalogo, planos, planos_venda, alertas, fiscal, relatorios
