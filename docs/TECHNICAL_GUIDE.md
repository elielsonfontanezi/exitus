# Technical Guide - Sistema Exitus v0.9.2
...
O **Sistema Exitus v0.9.2** é uma plataforma completa de gestão e análise de investimentos com multi-tenancy, motor fiscal completo e suporte a 15 tipos de ativos em múltiplos mercados (Brasil, EUA, Internacional).

### Principais Funcionalidades
- **Multi-tenancy**: Suporte para assessoras com múltiplos clientes
- **Consolidação Multi-Mercado**: BR, US, INTL em uma única plataforma
- **Motor Fiscal Completo**: IR, IOF, DARF, compensação de prejuízos
- **Buy Signals com IA**: Análise fundamentalista automatizada
- **Dashboard Interativo**: Performance, alocação, fluxo de caixa
- **Planos Disciplinados**: Compra e venda automatizados
- **Alertas Inteligentes**: Preço, eventos, notícias
- **Relatórios Completos**: Auditoria, exportação, análise fiscal
- **Multi-moeda**: BRL, USD, EUR com conversão automática
- **15 Tipos de Ativos**: Ações, FIIs, ETFs, Stocks, REITs, Bonds, Cripto, etc.
...
- [AUDITORIA_VISUAL.md](../AUDITORIA_VISUAL.md) - Análise visual completa do frontend
...
**Documento atualizado:** 19 de Março de 2026  
**Versão:** v0.9.2  
**Baseado em:** Sistema em produção com multi-tenancy, 155 endpoints, 436/497 testes passando (87.7%), 15 tipos de ativos, motor fiscal completo, frontend com 26 telas implementadas.
