...
class ProventoService:
    ...
    def get_all(usuario_id: UUID, page=1, per_page=50, filters=None):
        """Lista proventos do USUÁRIO via posicoes (FIX M3 FINAL)"""
        try:
    ...
    # MÉTODOS RESTANTES (get_by_id, create, update, delete, get_por_ativo, get_recebidos_usuario, calcular_total_recebido) - MANTEM IGUAIS
    @staticmethod
